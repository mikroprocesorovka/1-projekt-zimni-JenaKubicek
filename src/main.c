...
#define FAN_OFF  GPIO_WriteHigh(FAN_PORT,FAN_PIN)
#define FAN_ON GPIO_WriteLow(FAN_PORT,FAN_PIN)
...
void TIM2_setup(void){
    ...
    TIM2_OC1Init(TIM2_OCMODE_PWM1, TIM2_OUTPUTSTATE_ENABLE, 0, 
